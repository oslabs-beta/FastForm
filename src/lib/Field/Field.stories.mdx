...
| radio** | Array | `<Field name='desserts' type='radio' values= {['Cake', 'Doughnut', 'Ice Cream']} />` | 
| select** | Array | `<Field name='vegetables' type = 'multiselect' values = {['Brocolli', 'Kale', 'Asparagus']} />` |
| checkbox** | Array | `<Field name='drinks' type='multiselect' values={['Soda', 'Beer', 'Juice']} />` |
