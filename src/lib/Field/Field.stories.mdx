...
| **handleBlur** | No | Function | - | Instructions to be run onBlur, this function will trigger after validate function |
| **handleChange** | No | Function | - | Instructions to be run OnChange, this function will trigger after validate function|
...
| [multiselect](?path=/story/field-multi-select--multi-select)** | Array | `<Field name='fruits' type='multiselect' values={['Apple', 'Orange', 'Peach']} />` | 
| [radio](?path=/story/field-radio--radio)** | Array | `<Field name='desserts' type='radio' values= {['Cake', 'Doughnut', 'Ice Cream']} />` | 
| [select](?path=/story/field-select--select)** | Array | `<Field name='vegetables' type = 'multiselect' values = {['Brocolli', 'Kale', 'Asparagus']} />` |
| [checkbox](?path=/story/field-checkbox--checkbox)** | Array | `<Field name='drinks' type='multiselect' values={['Soda', 'Beer', 'Juice']} />` |
...
{#each iceCreamSelection as option}
  <input type='checkbox' value={option} bind:group={fruitSelection}/>
