...
|handleChange| No | Function| - | Function that defines what the form will do onChange. It takes one input which will be form state. Form state is a object which contains two objects labeled: values and errors.
